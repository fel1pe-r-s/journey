    ...
    <div className="h-screen flex items-center justify-center bg-pattern bg-no-repeat bg-center ">
      ...
      {isGuestsModalOpen && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
          <div className="w-[640px] rounded-xl py-5 shadow-shape px-6 bg-zinc-900 space-y-5">
            ...
            <form
              ...
              className="flex items-center gap-2 border border-zinc-800  flex-1 bg-zinc-950 p-2.5 rounded-lg"
            >
